...
export async function GET(request: Request) {
  ...
  // Construct redirect URL with all parameters and a flag for session restoration
  ...
  searchParams.set("restore_session", "true");

  return NextResponse.redirect(
    `${requestUrl.origin}/?${searchParams.toString()}`
  );
}
